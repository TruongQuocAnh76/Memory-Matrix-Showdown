...
public class Stage {
    ...
    public void game() {
        ...
        System.out.println("Enter the symbols that appeared, separated by spaces, in " + inputTime + " seconds");

        while (true) {
            System.out.println("Stage " + stageNumber);
            System.out.println("Gojo health " + gojo.getHealth() + " Dragon health " + dragon.getHealth());
